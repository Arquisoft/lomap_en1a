...
All these requirements can be found in link:https://asciidoctor.org[version 1.0 of the assignment description].
...
.Form
All requirements are specified in link:https://asciidoctor.org[version 1.0 of the assignment description].
