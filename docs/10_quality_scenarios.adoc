...
|QS3|Operational|Availability|The application must be available the 99% of the time.|Medium|High

|QS4|Operational|Performance|25 concurrent users request the map of a given city in less than 10 seconds.|High|High
