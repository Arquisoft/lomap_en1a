...
la url en la que se despliega es: [https://arquisoft.github.io/lomap_en1a/](https://arquisoft.github.io/lomap_en1a/).
...
Si queremos desplegar la documentación en GitHub pages, estará accesible en [https://arquisoft.github.io/lomap_en1a/](https://arquisoft.github.io/lomap_en1an1a/) necesitamos ejecutar `npm run deploy`.
